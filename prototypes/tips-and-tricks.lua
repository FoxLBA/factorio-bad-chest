  ...
  },
  {
    ...
    localised_description = {
      ...
      {"",
        ...
        {"rbp-tnt-description-parts.deployer2-library", rbp_signals("library")}, "\n\n",
        {"rbp-tnt-description-parts.deployer2-wires", rbp_signals("command")}, "\n\n",
      },
      {"",
        {"rbp-tnt-description-parts.deployer2-com-header"}, "\n",
      ...
      {"",
        ...
        {"rbp-tnt-description-parts.deployer2-com102", rbp_signals({"library", "superforce", "book-layer1"})}, "\n\n",
